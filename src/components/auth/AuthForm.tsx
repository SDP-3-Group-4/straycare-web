    ...
    <div className="auth-form">
      ...
      <form onSubmit={handleSubmit} noValidate className="auth-form__fields transition-all duration-300">
          ...
          <>
            ...
            >
              ...
              <div className="auth-form__input-wrapper">
                <User size={18} className="auth-form__input-icon" aria-hidden="true" />
                <Input
                  id="auth-name"
              ...
              {errors.name && <FieldError className="auth-form__error">{errors.name}</FieldError>}
            </TextField>
            ...
            >
              ...
              <div className="auth-form__input-wrapper">
                <Phone size={18} className="auth-form__input-icon" aria-hidden="true" />
                <Input
                  id="auth-phone"
                  type="tel"
              ...
              {errors.phone && <FieldError className="auth-form__error">{errors.phone}</FieldError>}
            </TextField>
          </>
        )}
        ...
        >
          ...
          <div className="auth-form__input-wrapper">
            <Mail size={18} className="auth-form__input-icon" aria-hidden="true" />
            <Input
              id="auth-email"
              type="email"
          ...
          {errors.email && <FieldError className="auth-form__error">{errors.email}</FieldError>}
        </TextField>
        ...
        >
          ...
          <div className="auth-form__input-wrapper">
            <Lock size={18} className="auth-form__input-icon" aria-hidden="true" />
            <Input
              id="auth-password"
        ...
        {isRegister && (
          ...
          >
            ...
            {errors.confirmPassword && (
              <FieldError className="auth-form__error">{errors.confirmPassword}</FieldError>
            )}
          </TextField>
        )}
        ...
        {isRegister && (
          ...
          >
            ...
            <div className="auth-form__input-wrapper">
              <Ticket size={18} className="auth-form__input-icon" aria-hidden="true" />
              <Input
                id="auth-referral"
