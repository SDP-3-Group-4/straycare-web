    ...
    fetchMarketplaceItems()
      .then((data: any[]) => {
        const mappedItems: MarketItem[] = data.map((item) => ({
          ...
          isService:
            item.category === "Services" || item.category === "Training",
        }));
  ...
  return (
    <div className="flex flex-col w-full pb-24 pt-3 sm:pt-6 lg:pt-[74px] px-1 sm:px-4 lg:px-6">
      ...
      <div className="relative group mb-4 sm:mb-6">
        <Search
          className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[var(--sc-brand-500)] transition-colors"
          size={18}
        />
        <input
          type="text"
      ...
      {filteredItems.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl border border-[var(--sc-border)] p-6">
          ...
          <h3 className="font-bold text-base sm:text-lg text-[var(--sc-text-primary)] mb-1">
            No items found
          </h3>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-left">
                ...
                <span
                  className="text-sm font-extrabold notranslate"
                  translate="no"
                >
