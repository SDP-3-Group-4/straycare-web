...
const SETTINGS_OPTIONS = [
  ...
  },
  {
    id: "settings",
    label: "Settings",
    sub: "Privacy, account & verification",
    icon: Settings,
    path: "/settings",
  },
  {
  ...
  return (
    <div ref={wrapRef} className="relative group w-full">
      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        <Search
          size={18}
          className="text-[var(--sc-text-muted)] group-focus-within:text-[var(--sc-brand-500)]"
        />
      </div>
      <input
        type="search"
            ...
            {loading ? (
              ...
              <>
                {filteredUsers.length > 0 && (
                  <div className="p-2">
                    <p className="text-[11px] font-bold text-gray-400 px-3 py-1.5 ">
                      Users
                    </p>
                    {filteredUsers.map((u) => (
                      <button
                      ...
                      >
                        ...
                        <div className="flex flex-col flex-1 min-w-0">
                          <span className="font-bold text-[14px] text-[var(--sc-text-primary)] truncate">
                            {u.displayName}
                          </span>
                          <span
                            className="text-[12px] text-gray-500 truncate notranslate"
                            translate="no"
                          >
