                  ...
                  <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 bg-gray-100 flex items-center justify-center">
                    {(
                      comment.userId === user?.uid
                        ? user?.photoUrl || comment.user.photoUrl
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="bg-gray-100 rounded-2xl p-3 inline-block">
                      <div className="flex justify-between items-start gap-4">
                        <span
                          className="font-bold text-[13px] notranslate"
                          translate="no"
                        >
                      ...
                      {editingId === comment.id ? (
                        <div className="flex flex-col gap-2 mt-1">
                          ...
                          <div className="flex gap-2 justify-end">
                            ...
                            <button
                              ...
                              className="text-xs text-[var(--sc-brand-500)] font-bold"
                            >
                              Save
                            </button>
                          </div>
                        ...
                        <div className="text-sm mt-1 text-gray-800 whitespace-pre-wrap">
                          {comment.content.includes("[Disclaimer]") ||
                          comment.content.includes("**Disclaimer**:") ? (
                            <>
                                  ...
                                  .map((line, i) => {
                                    ...
                                    if (trimmedLine.startsWith("-")) {
                                      return (
                                        ...
                                        >
                                          <span className="text-blue-500 mt-0.5 text-[10px]">
                                            ⬤
                                          </span>
