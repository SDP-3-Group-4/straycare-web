...
export default function ProfileFlyoutMenu({
  isOpen,
  onClose,
}: ProfileFlyoutMenuProps) {
        ...
        <div className="relative z-10 w-full sm:w-96 bg-white rounded-b-3xl sm:rounded-3xl shadow-2xl border border-[var(--sc-border)] flex flex-col overflow-hidden max-h-[92vh] animate-in slide-in-from-top-3 sm:slide-in-from-right-3 duration-200 mt-0 sm:mt-14 mr-0 sm:mr-4">
          ...
          <div className="p-4 overflow-y-auto flex flex-col gap-4">
            ...
            <div className="p-3.5 rounded-2xl bg-white border border-[var(--sc-border)] shadow-xs flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  {isVerifiedVet && (
                    <span className="px-1.5 py-0.2 bg-green-100 text-green-700 text-[9px] font-bold rounded-md shrink-0">
                      Vet
                    </span>
                  )}
                </div>
            ...
            <div className="flex flex-col gap-3">
              <span className="text-[11px] font-bold text-[var(--sc-text-secondary)] pl-1">
              ...
              <div className="p-3 bg-gray-50/80 rounded-2xl border border-[var(--sc-border)] flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs font-bold text-[var(--sc-text-primary)] truncate">
                      Blur Sensitive Injury Media
                    </span>
                    <span className="text-[10px] text-gray-500">
                      Tap to reveal graphic rescue posts
                    </span>
                  </div>
                </div>
              ...
              <div className="p-3 bg-gray-50/80 rounded-2xl border border-[var(--sc-border)] flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[10px] text-gray-500">
                      Instant notices for nearby animals
                    </span>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[11px] text-gray-500">
                      Password, identity & data export
                    </span>
                  </div>
                </div>
                <ChevronRight
                  size={15}
                  className="text-gray-400 group-hover:text-[var(--sc-brand-600)]"
                />
              </Link>
            </div>
